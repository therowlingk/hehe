...
function claim($token)
	...
	function claim7($token)
    {
    $data = '{"promo_code":"HEPIUPNORMAL"}';    
    $claim = request("/go-promotions/v1/promotions/enrollments", $token, $data);
    if ($claim['success'] == 1)
        {
        return $claim['data']['message'];
	...
	function claim8($token)
    {
    $data = '{"promo_code":"HEPIPANGERAN"}';    
    $claim = request("/go-promotions/v1/promotions/enrollments", $token, $data);
    if ($claim['success'] == 1)
        {
        return $claim['data']['message'];
	...
	function claim9($token)
    {
    $data = '{"promo_code":"HEPIXINGFUTANG"}';    
    $claim = request("/go-promotions/v1/promotions/enrollments", $token, $data);
    if ($claim['success'] == 1)
        {
        return $claim['data']['message'];
	...
	function claim10($token)
    {
    $data = '{"promo_code":"HEPIBOEDJANGAN"}';    
    $claim = request("/go-promotions/v1/promotions/enrollments", $token, $data);
    if ($claim['success'] == 1)
        {
        return $claim['data']['message'];
	...
	function claim11($token)
    {
    $data = '{"promo_code":"HEPIMALAMMINGGU"}';    
    $claim = request("/go-promotions/v1/promotions/enrollments", $token, $data);
    if ($claim['success'] == 1)
        {
        return $claim['data']['message'];
